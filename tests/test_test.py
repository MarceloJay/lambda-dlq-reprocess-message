...
from handler.services.process import ProcessMessage

class TestProcessMessage(unittest.TestCase):

    @patch('handler.services.cloudwatch.CloudWatch')
    @patch('handler.dataprovider.sqs_queue.SQSQueue')
    @patch('handler.dataprovider.send_to_aws_sqs.SendToAwsSqs')
    def setUp(self, MockSendToAwsSqs, MockCloudWatch, MockSQSQueue):
